...
class Auto {
    ...
    convenience init() {
        self.init(velocidadInicial: Velocidades.Apagado)
    }
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        print("MiniReto de Semana4_____________________________________")
        print("________________________________________________________")
        print("")
        ...
        for var i = 1; i <= 20; i++ {
            print(" Cambio de velocidad nº \(i) a \(auto.cambioDeVelocidad())")
        }
